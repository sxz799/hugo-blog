...
![](https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/202208/202208141614588.png)
...
```
![](https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/202208/202208141615122.png)
改成这样之后我们发现 `printString(add)`报错了，根据提示可以发现使用指针作为方法接收者，则只有指针实现了该方法，使用值作为方法接收者，则值和指针都实现了该方法。

再看下面的代码
![](https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/202208/202208141620617.png)
...
![](https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/202208/202208141612114.png)
