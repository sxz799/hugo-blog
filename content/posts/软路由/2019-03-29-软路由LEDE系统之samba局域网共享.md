...
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190329233210.png" width="600px" />
...
### 先运行分区工具
`fdisk /dev/sda`
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190329233753.png" width="600px" />
### 输入p查看当前分区
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190329234053.png" width="600px" />
### 输入n创建新的分区
这里由于我已经创建 就不在截图了 
...
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190329235605.png" width="600px" />
选择挂载点，在自定义位置填入`/mnt/sda5` (挂载器要创建这个空文件夹，注意不要输错了)
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190330000544.png" width="600px" />
## 三、将新创建的分区添加到samba的共享目录
这里也很简单 按照下图的设置即可
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190330001456.png" width="600px" />
### 给samba用户添加密码
