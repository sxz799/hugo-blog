...
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190415201614.png" width="600px" />
## 二、安装镜像
1. 勾选使用高权限执行容器
2. 点击高级设置
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190415222913.png" width="600px" />
3. 在卷属性卡中点击添加文件，并选择你期望远程迅雷的下载位置（自定义）
4. 装载路径为 /TDDOWNLOAD （不可更改！！！）
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190415223001.png" width="600px" />
5. 网络选择左下角的与Docker Host使用相同的网络
6. 点击应用创建容器
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190415223020.png" width="600px" />
7. 点开Docker页面左侧的容器选项卡，点击刚创建的容器，然后点击左上角的详情
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190415223057.png" width="600px" />
8. 在弹出的页面中选择日志选项卡，找到最下面的`THE ACTIVE CODE IS: aabbcc` ,记录后面的代码
<img src="https://cdn.jsdelivr.net/gh/sxz799/tuchuang-blog/img/2019/20190415223150.png" width="600px" />
